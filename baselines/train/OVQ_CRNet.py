...
# SAVE THE PLOT
plot_path = "../../outputs/plots/OVQ_CRNet_pre_train_rec_loss.png"
plt.savefig(plot_path)
print(f"Plot saved to {plot_path}")

# Save the losses to a text file
losses_file_path = "../../outputs/logs/OVQ_CRNet_pre_train_rec_loss.txt"
...
# SAVE THE PLOT
plot_path = "../../outputs/plots/OVQ_CRNet_fine_tune_rec_loss.png"
plt.savefig(plot_path)
print(f"Plot saved to {plot_path}")

# Save the losses to a text file
losses_file_path = "../../outputs/logs/OVQ_CRNet_fine_tune_rec_loss.txt"
with open(losses_file_path, 'w') as f:
...
model_path = "../../outputs/models/OVQ_CRNet_path.pth"
